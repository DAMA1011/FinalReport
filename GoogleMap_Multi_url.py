...
def FirstPage():
    ...
    street = ['長安西路', '保安街', '大南京西路', '哈密街', '迪化街一段', '迪化街二段', '重慶北路一段', '重慶北路二段', '重慶北路三段', '庫倫街', '酒泉街', '涼州街']
    # '通河西街一段', '敦煌路', '景化街', '華亭街', '華陰街', '貴德街', '塔城街', '萬全街', '寧夏路', '撫順街', '鄭州路', '興城街', '錦西街'

    category = ['火鍋', '拉麵', '日本料理', '美式', '義式', '法式', '中式', '台灣菜', '韓式', '德式', '地中海料理', '印度料理', '越式', '港式', '泰式', '南洋', '素食', '鐵板燒', '餐酒館', '咖啡廳', '熱炒店', '早午餐', '甜點店', '燒肉', '海鮮餐廳', '牛排']  # 26 * category
    ...
    with ppe(max_workers=4) as executor:
        ...
        try:
            ...
            # 寫出 json 檔
            with open(f'台北市大同區.json', 'w', encoding='utf-8') as file:
...
# ['大龍街_', '五原路_', '天水路_', '太原路_', '市民大道一段_', '平陽街_', '民生西路_', '民族西路_', '民樂街_', '民權西路_', '永昌街_', '甘州街_', '甘谷街_', '伊寧街_', '安西街_', '西寧北路_', '赤峰街_', '延平北路一段_', '延平北路二段_', '延平北路三段_', '延平北路四段_', '忠孝西路二段_', '承德路一段_', '承德路二段_', '承德路三段_', '昌吉街_', '長安西路', '保安街', '大南京西路', '哈密街', '迪化街一段', '迪化街二段', '重慶北路一段', '重慶北路二段', '重慶北路三段', '庫倫街', '酒泉街', '涼州街', '通河西街一段', '敦煌路', '景化街', '華亭街', '華陰街', '貴德街', '塔城街', '萬全街', '寧夏路', '撫順街', '鄭州路', '興城街', '錦西街', '環河北路一段_', '環河北路二段_', '歸綏街_', '雙連街_', '蘭州街_']
