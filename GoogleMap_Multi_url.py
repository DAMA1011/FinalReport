...
def FirstPage():
    ...
    with ppe(max_workers=5) as executor:
        ...
        try:
            ...
            # 寫出 json 檔
            with open(f'台北市士林區後港街.json', 'w', encoding='utf-8') as file:
...
# 士林區 ["下樹林街_", "中山北路四段_", "中山北路五段_", "中山北路六段_", "中山北路七段_", "中庸一路_", "中庸二路_", "中庸五路_", "中正路_", "中社路一段_", "中社路二段_", "中興街_", "中華路_", "仁民路_", "仰德大道一段_", "仰德大道二段_", "仰德大道三段_", "仰德大道四段_", "倫等街_", "光華路_", "克強路_", "凱旋路_", "前港街_", "前街_", "劍南路_", "劍潭路_", "力行街_", "和平路_", "和豐街_", "國泰街_", "基河路_", "士商路_", "士東路_", "大亨路_", "大光街_", "大北路_", "大南路_", "大東路_", "大西路_", "天母北路_", "天母東路_", "天母西路_", "天玉街_", "安平街_", "小北街_", "小南街_", "小東街_", "小西街_", "平菁街_", "幸福街_", "延平北路五段_", "延平北路六段_", "延平北路七段_", "延平北路八段_", "延平北路九段_", "建業路_", "後港街", "後街", "德行東路", "德行西路", "志成街", "忠勇街", "忠義街", "忠誠路一段", "忠誠路二段", "愛富一街", "愛富三街", "愛富三街長生巷", "愛富二街", "愛富二街厚生巷", "愛富二街樂生巷", "承德路四段", "承德路五段", "故宮路", "文昌路", "文林路", "新園街", "新安路", "明溪街", "東山路", "格致路", "永公路", "永平街", "環河北路三段", "磺溪街", "社中街", "社子街", "社正路", "福國路", "福壽街", "福德路", "福志路", "福林路", "福榮街", "福港街", "福華路", "竹子湖路", "美崙街", "美德街", "翠山街", "臨溪路", "自祥街", "至善路一段", "至善路二段", "至善路三段", "至誠路一段", "至誠路二段", "芝玉路一段", "芝玉路二段", "莊頂路", "菁山路", "華光街", "華岡路", "華榮街", "華聲街", "華興街", "華齡街", "葫東街", "葫蘆街", "貴富街", "通河東街一段", "通河東街二段", "通河街", "通河西街一段", "通河西街二段", "重慶北路四段", "長春街", "陽明路一段", "陽明路二段", "雙溪街", "雨聲街", "雨農路"]

# 行政區 ['中正區', '大同區', '中山區', '松山區', '大安區', '萬華區', '信義區', '士林區', '北投區', '內湖區', '南港區', '文山區']