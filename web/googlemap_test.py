...
# df_p = pd.read_csv('place_info_final_1217.csv')
...
# df3_p.to_csv('place_info_final_url.csv', encoding='utf-8', index=False, sep=',')
...
# df3_a.to_csv('attraction_info_final_url.csv', encoding='utf-8', index=False, sep=',')
